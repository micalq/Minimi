        ...
        <template slot="tip">
            ...
            <div class="wraper">
              <div class="container">
                  ...
                  <th><span class="checkbox" :class="{'checked':selectedAll}" @click="isChecked"></span>全选</th>
                  <th>商品名称</th>
                  <th>单价</th>
                  <th>数量</th>
                  <th>小计</th>
                ...
                <tr v-for="(item) in cartList" :key="item.id">
                  ...
                  <td><span class="checkbox" v-bind:class="{'checked':item.productSelected}" @click="update(item)"></span></td>
                  <td class="two">
               ...
               <div class="ad" >
                    <div class="container clearfix">
                     <div class="on fl">
                 <a href="/#/index">继续购物</a>
             共<span class="checked">{{cartList.length}}</span>件商品，已选择<span>{{checkNum}}</span>件
               </div>
               <div class="total fr">
...
export default {
 ...
 OrderHeader,
    ...
    methods: {
      ...
      update(item,type){//加减按钮以及单选框
        let quantity=item.quantity,
            selected=item.productSelected;//数量和单选框是否选中
            if(type=="+"){
              if(quantity>item.productStock){//如果大于库存
                alert("购买商品大于库存");
                return
              }
              ++quantity;
