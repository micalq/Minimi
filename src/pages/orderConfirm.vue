<template>
  <div class="order-confirm">
    ...
    <div class="wrapper">
      <div class="container">
        <div class="order-box">
          ...
          <div class="btn-group">
            <a href="/#/cart"> <el-button type="primary">返回购物车</el-button></a>
            <a href="javascript:;" @click="orderSubmit"><el-button type="info">去结算</el-button></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <model
      title="删除确认"
      btnType="1"
      :showModel="showDelModal"
      @cacel="showDelModal=false"
      @submit="submitAddress"
    >
      <template v-slot:body>
        <p>您确认要删除此地址吗？</p>
